        ...
        <form action="{{ route('store-new-client') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-md-3 mb-2">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control border-@if($errors->has('name')){{ __('danger') }}
                    @endif" autofocus />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" class="form-control border-@if($errors->has('phone')){{ __('danger') }} @endif" />
                    @if ($errors->has('phone'))
            ...
            <div class="row mb-md-3 mb-2">
                <div class="col-md-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="form-control border-@if($errors->has('email')){{ __('danger') }} @endif" />
                    @if ($errors->has('email'))
            ...
            <div class="row mb-md-4 mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="page_number" value="{{ old('page_number') }}" id="" class="form-control" />
                </div>
